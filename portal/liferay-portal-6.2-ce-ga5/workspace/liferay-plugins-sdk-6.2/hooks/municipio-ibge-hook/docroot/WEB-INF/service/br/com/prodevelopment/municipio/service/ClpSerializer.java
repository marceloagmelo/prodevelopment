...
import br.com.prodevelopment.municipio.model.MunicipioClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"municipio-ibge-hook-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "municipio-ibge-hook";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"br.com.prodevelopment.municipio.model.impl.MunicipioImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"br.com.prodevelopment.municipio.NoSuchMunicipioException")) {
			return new br.com.prodevelopment.municipio.NoSuchMunicipioException();
		}
