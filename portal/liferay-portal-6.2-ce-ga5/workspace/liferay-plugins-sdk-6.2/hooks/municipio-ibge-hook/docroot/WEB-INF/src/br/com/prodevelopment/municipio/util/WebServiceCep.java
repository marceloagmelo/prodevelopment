package br.com.prodevelopment.municipio.util;
 ...
 * {@link WebServiceCep#searchCep(String)} para maiores informações. <BR>
 * <BR>
 * Constroi um objeto {@link WebServiceCep} com os dados XML encapsulados, a
 * partir da chamada do método estatico {@link WebServiceCep#searchCep(String)}. <BR>
 * <BR>
 * Objeto contem todas as informações do XML, além de informações referente ao
 * resultado da pesquisa. <BR>
 * <BR>
 * Esta ferramente depende diretamente do pacote <tt>org.dom4j</tt> para fazer o
 * parse dos arquivos XML. O pacote dom4j.jar pode ser encontrado em <a
 * href="http://www.dom4j.org/dom4j-1.6.1/download.html"
 * target="_blank">dom4j.org</a> <BR>
 * <BR>
 * Exemplo de uso: <BR>
...
public final class WebServiceCep {
	...
	private enum Xml {
		 ...
		 * @param webServiceCep
		 *            {@link WebServiceCep} referencia do objeto para inserir o
		 *            parametro text.
		 */
	 ...
	 * objeto {@link WebServiceCep}. <BR>
	 * <BR>
	 * Não se faz necessário formatações, a string pode ser enviada em qualquer
	 * formatação, pois só serão consideradas os primeiros 8 numeros da string. <BR>
	 * Por Exemplo: <BR>
	 * Uma <tt>{@link String} "14.568-910"</tt> é automaticamente passada para
	 * <tt>"14568910"</tt>. <BR>
	 * Uma <tt>{@link String} "1%4#5?55%16a8&910"</tt> é automaticamente passada
	 * para <tt>"14555168"</tt>, só levando em conta os primeiros 8 números.
	 * 
	 * @param cep
	 *            Número do cep a ser carregado. Só serão considerados os
	 *            primeiros 8 números da {@link String} enviada. Todos os
	 *            caracters não numéricos serão removidos, e a string será
	 ...
	 * @throws CEPNaoFoiPossivelLerXMLException
	 * @throws CEPFormatacaoXMLException
	 * @throws CEPInesperadoException
	 */
	public static WebServiceCep searchCep(String cep) {
		...
		try {
			...
			if (ex.getNestedException() != null
				...
				//throw new CEPNaoFoiPossivelLerXMLException();
			}
	...
	/*
	 * PRIVATE métodos set, usados pela classe Xml para setar o objeto
	 * CepWebService
	 */
	 ...
	 *         <tt>false</tt> - caso haja falhas, ou o cep enviado não esteja
	 *         cadastrado.
	 */
	 ...
	 *         <tt>false</tt> - Caso haja falhas, ou caso o cep esteja
	 *         cadastrado.
	 */
