...
public class ConfigurationActionImpl extends DefaultConfigurationAction {
	...
	public String render(PortletConfig portletConfig, RenderRequest renderRequest,
		...
		boolean prefClienteSomenteEsseSite = GetterUtil.getBoolean(portletPreferences.getValue(
				Constantes.PREF_CLIENTE_SOMENTE_ESSE_SITE, null));
		
		renderRequest.setAttribute(Constantes.PREF_CLIENTE_SOMENTE_ESSE_SITE, prefClienteSomenteEsseSite);
    ...
    public void processAction(PortletConfig portletConfig, ActionRequest actionRequest, 
		...
		String prefClienteSomenteEsseSite = ParamUtil.getString(actionRequest,
				Constantes.PREF_CLIENTE_SOMENTE_ESSE_SITE);

    	prefs.setValue(Constantes.PREF_CLIENTE_SOMENTE_ESSE_SITE, prefClienteSomenteEsseSite);
