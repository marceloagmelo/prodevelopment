 ...
 * @generated
 */
public abstract class ClienteLimCreditoActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ClienteLimCreditoActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ClienteLimCreditoLocalServiceUtil.getService());
		setClass(ClienteLimCredito.class);

		setClassLoader(br.com.prodevelopment.cliente.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("clienteLimCreditoId");
	}
}