...
/**
 * Provides the local service interface for ClienteLimCredito. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author marcelo
 * @see ClienteLimCreditoLocalServiceUtil
...
public interface ClienteLimCreditoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ClienteLimCreditoLocalServiceUtil} to access the cliente lim credito local service. Add custom service methods to {@link br.com.prodevelopment.cliente.service.impl.ClienteLimCreditoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
