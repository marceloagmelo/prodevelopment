...
/**
 * Provides the local service interface for Cliente. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author marcelo
 * @see ClienteLocalServiceUtil
...
public interface ClienteLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ClienteLocalServiceUtil} to access the cliente local service. Add custom service methods to {@link br.com.prodevelopment.cliente.service.impl.ClienteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
