...
if (Validator.isNotNull(clienteId)) {
	cliente = ClienteUtil.getCliente(Long.valueOf(clienteId));
	endResUf = cliente.getEndResUf();
	endComUf = cliente.getEndComUf();
}
%>
...
<aui:input name="cidadeComSelecionada" type="hidden" value="<%= Validator.isNotNull(cliente) ? cliente.getEndComCidade() : 0 %>" />
<aui:input name="cidadeResSelecionada" type="hidden" value="<%= Validator.isNotNull(cliente) ? cliente.getEndResCidade() : 0 %>" />
