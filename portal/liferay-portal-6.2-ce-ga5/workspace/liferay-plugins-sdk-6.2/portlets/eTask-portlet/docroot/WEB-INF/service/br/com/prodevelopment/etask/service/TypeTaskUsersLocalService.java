...
/**
 * Provides the local service interface for TypeTaskUsers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcelo Melo
 * @see TypeTaskUsersLocalServiceUtil
...
public interface TypeTaskUsersLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TypeTaskUsersLocalServiceUtil} to access the type task users local service. Add custom service methods to {@link br.com.prodevelopment.etask.service.impl.TypeTaskUsersLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
