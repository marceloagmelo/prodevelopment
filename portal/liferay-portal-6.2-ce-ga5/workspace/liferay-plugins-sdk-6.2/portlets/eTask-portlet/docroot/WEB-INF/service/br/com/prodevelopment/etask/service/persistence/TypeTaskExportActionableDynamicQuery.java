 ...
 * @generated
 */
public class TypeTaskExportActionableDynamicQuery
	extends TypeTaskActionableDynamicQuery {
	public TypeTaskExportActionableDynamicQuery(
	...
	protected void addCriteria(DynamicQuery dynamicQuery) {
		...
		if (_portletDataContext.isInitialPublication()) {
			...
			StagedModelDataHandler<?> stagedModelDataHandler = StagedModelDataHandlerRegistryUtil.getStagedModelDataHandler(TypeTask.class.getName());
	...
	protected void performAction(Object object)
		...
		TypeTask stagedModel = (TypeTask)object;
