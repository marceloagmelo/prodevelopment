...
/**
 * Provides the local service interface for TypeTicketUsers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcelo Melo
 * @see TypeTicketUsersLocalServiceUtil
...
public interface TypeTicketUsersLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TypeTicketUsersLocalServiceUtil} to access the type ticket users local service. Add custom service methods to {@link br.com.prodevelopment.eticket.service.impl.TypeTicketUsersLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
