 ...
 * @generated
 */
public abstract class TypeTicketUsersActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public TypeTicketUsersActionableDynamicQuery() throws SystemException {
		setBaseLocalService(TypeTicketUsersLocalServiceUtil.getService());
		setClass(TypeTicketUsers.class);

		setClassLoader(br.com.prodevelopment.eticket.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("typeTicketUsersId");
	}
}