...
/**
 * Provides the local service interface for TypeTicket. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcelo Melo
 * @see TypeTicketLocalServiceUtil
...
public interface TypeTicketLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TypeTicketLocalServiceUtil} to access the type ticket local service. Add custom service methods to {@link br.com.prodevelopment.eticket.service.impl.TypeTicketLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
