...
public class ConfiguracaoActionImpl extends DefaultConfigurationAction {
	...
	public void processAction(PortletConfig portletConfig,
		...
		String cargos = ParamUtil.getString(actionRequest,
				Constantes.PREF_CARGOS);
		...
		portletPreferences.setValue(Constantes.PREF_CARGOS, cargos);
	...
	public String render(PortletConfig portletConfig,
		...
		String cargos = preferences.getValue(Constantes.PREF_CARGOS,
				Constantes.VAZIO);
		String emails = preferences.getValue(Constantes.PREF_EMAILS,
				Constantes.VAZIO);

		renderRequest.setAttribute(Constantes.PREF_CARGOS, cargos);
