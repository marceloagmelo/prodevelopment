package br.com.elmaragon.produto.lista.portlet;
...
import br.com.elmaragon.produto.util.Helper;
import br.com.elmaragon.produto.util.Search;
...
/**
 * Portlet implementation class ProdutoListaPortlet
 */
public class ProdutoListaPortlet extends MVCPortlet {
	...
	public void render(RenderRequest renderRequest,
		...
		try {
			...
			if (Constantes.S.equals(prefConfigurado)) {
				...
				List<ProdutoVO> produtos = busca.buscarProdutos(estrutura,
						categoria, Constantes.TITULO, tag, inicioPag, fimPag,
				...
				renderRequest.setAttribute(Constantes.NOME_PARAM_PAGINACAO,
						prefPaginacao);
				renderRequest.setAttribute(Constantes.LISTA_PRODUTOS, produtos);
				renderRequest
