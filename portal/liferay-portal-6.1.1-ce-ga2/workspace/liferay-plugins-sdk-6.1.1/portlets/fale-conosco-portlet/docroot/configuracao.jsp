...
<form action="<%=configuracaoURL%>" method="post" name="fm">
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td><liferay-ui:message key="label.faleConosco.assuntos" />
				<p>
					<textarea rows="10" cols="80" name="prefAssuntos">${prefAssuntos }</textarea>
			</td>
		</tr>
		<tr>
			<td><liferay-ui:message key="label.faleConosco.emails" /><br>
