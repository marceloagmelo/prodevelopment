...
<script type="text/javascript">
	<%@ include file="/js/videorotativo/jquery.js" %>
</script>
...
<fieldset>
	...
	<liferay-ui:message key="destino"/>
	<select name="target">
		<option value="_blank" <%="_blank".equals(request.getAttribute("target"))?"selected":""%>><liferay-ui:message key="pagina-em-branco"/></option>
		<option value="_self" <%="_self".equals(request.getAttribute("target"))?"selected":""%>><liferay-ui:message key="mesma-pagina"/></option>
	</select>
</fieldset>
