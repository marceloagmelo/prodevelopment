package br.com.prodevelopment.video.rotativo.portlet;
...
/**
 * Portlet implementation class VideoRotativoPortlet
 */
public class VideoRotativoPortlet extends MVCPortlet {
	...
	public void init() throws PortletException {
		...
		viewSingleJSP = getInitParameter(Constantes.JSP_VIEW_SINGLE);
	...
	public void render(RenderRequest request, RenderResponse response)
		...
		request.setAttribute("target",preferences.getValue(Constantes.DESTINO_TARGET, ""));
