package br.com.prodevelopment.video.lista.portlet;
...
import br.com.prodevelopment.video.util.Helper;
...
/**
 * Portlet implementation class ListaVideoPortlet
 */
public class ListaVideoPortlet extends MVCPortlet {
	...
	public void render(RenderRequest renderRequest,
		...
		try {
			...
			if (Constantes.S.equals(prefConfigurado)) {
				...
				List<VideoVO> videos = busca.buscarVideos(null, categoria,
						Field.MODIFIED_DATE, tag, inicioPag, fimPag,
						renderRequest);

				renderRequest.setAttribute(
						Constantes.NOME_PARAM_TOTAL_REGISTROS,
						busca.getTotalVideos());
				renderRequest.setAttribute(Constantes.NOME_PARAM_PAGINACAO,
						prefPaginacao);
				renderRequest.setAttribute(Constantes.VIDEOS, videos);
				renderRequest
						.setAttribute(Constantes.NOME_PARAM_PAGINA, pagina);
				renderRequest.setAttribute(Constantes.TOTAL,
						busca.getTotalVideos());
