package br.com.prodevelopment.video.rotativo.action;
...
public class ConfigurationActionImpl extends DefaultConfigurationAction {
	...
	public String render(PortletConfig portletConfig,
		...
		String urlDestino = preferences.getValue(Constantes.URL_DESTINO, "");
		...
		renderRequest.setAttribute("target",
				preferences.getValue(Constantes.DESTINO_TARGET, ""));
		...
		return "/html/videorotativo/config.jsp";
	}
	...
	public void processAction(PortletConfig portletConfig,
		...
		portletPreferences.setValue(Constantes.DESTINO_TARGET,
				actionRequest.getParameter("target"));
