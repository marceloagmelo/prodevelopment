...
%>
	...
	<aui:input name="folderId" id="folderId"
		type="hidden" value="${folderId }" />
	...
	<p>
	<aui:button onClick="<%= sbBotao.toString() %>" value="botao.selecionar.esta.pasta" />
	</p>
		<liferay-ui:search-container
			emptyResultsMessage="mensagem.nao.existem.pastas" delta="<%=pageSize %>">
