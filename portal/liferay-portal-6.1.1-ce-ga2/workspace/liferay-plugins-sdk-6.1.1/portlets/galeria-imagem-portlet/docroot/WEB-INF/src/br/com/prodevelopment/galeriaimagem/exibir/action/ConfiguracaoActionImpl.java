package br.com.prodevelopment.galeriaimagem.exibir.action;

import br.com.prodevelopment.galeriaimagem.exibir.Constantes;
...
public class ConfiguracaoActionImpl extends DefaultConfigurationAction {
	...
	public String render(PortletConfig portletConfig,
		...
		try {
			...
			boolean prefExibirTituloPasta = GetterUtil.getBoolean(prefs
					.getValue(Constantes.PREF_EXIBIR_TITULO_PASTA,
							Constantes.DEFAULT_PREF_EXIBIR_PASTA));
			String prefQtdeRegistros = GetterUtil.getString(prefs.getValue(
					Constantes.PREF_QTDE_REGISTROS,
					Constantes.DEFAULT_QTDE_REGISTROS));
			String prefLarguraImagem = GetterUtil.getString(prefs.getValue(
					Constantes.PREF_LARGURA_IMAGEM,
					Constantes.DEFAULT_LARGURA_IMAGEM));
			String prefAlturaImagem = GetterUtil.getString(prefs.getValue(
					Constantes.PREF_ALTURA_IMAGEM,
