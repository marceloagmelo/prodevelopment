...
import br.com.prodevelopment.pesquisaopiniao.NoSuchRespostaException;
...
import br.com.prodevelopment.pesquisaopiniao.model.impl.RespostaModelImpl;
...
public class RespostaPersistenceImpl extends BasePersistenceImpl<Resposta>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_PERGUNTAID =
		new FinderPath(RespostaModelImpl.ENTITY_CACHE_ENABLED,
			RespostaModelImpl.FINDER_CACHE_ENABLED, RespostaImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByPerguntaId",
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PERGUNTAID =
		new FinderPath(RespostaModelImpl.ENTITY_CACHE_ENABLED,
			RespostaModelImpl.FINDER_CACHE_ENABLED, RespostaImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByPerguntaId",
			new String[] { Long.class.getName() },
			RespostaModelImpl.PERGUNTAID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_PERGUNTAID = new FinderPath(RespostaModelImpl.ENTITY_CACHE_ENABLED,
			RespostaModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByPerguntaId",
			new String[] { Long.class.getName() });
	...
	public Resposta updateImpl(
		...
		if (isNew || !RespostaModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((respostaModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PERGUNTAID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(respostaModelImpl.getOriginalPerguntaId())
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_PERGUNTAID,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PERGUNTAID,
					args);
	...
	public List<Resposta> findByPerguntaId(long perguntaId)
		throws SystemException {
		return findByPerguntaId(perguntaId, QueryUtil.ALL_POS,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Resposta> findByPerguntaId(long perguntaId, int start, int end)
		throws SystemException {
		return findByPerguntaId(perguntaId, start, end, null);
	}
	...
	public List<Resposta> findByPerguntaId(long perguntaId, int start, int end,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PERGUNTAID;
			finderArgs = new Object[] { perguntaId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_PERGUNTAID;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_PERGUNTAID_PERGUNTAID_2);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Resposta findByPerguntaId_First(long perguntaId,
		OrderByComparator orderByComparator)
		throws NoSuchRespostaException, SystemException {
		Resposta resposta = fetchByPerguntaId_First(perguntaId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Resposta fetchByPerguntaId_First(long perguntaId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Resposta> list = findByPerguntaId(perguntaId, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Resposta findByPerguntaId_Last(long perguntaId,
		OrderByComparator orderByComparator)
		throws NoSuchRespostaException, SystemException {
		Resposta resposta = fetchByPerguntaId_Last(perguntaId, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Resposta fetchByPerguntaId_Last(long perguntaId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByPerguntaId(perguntaId);

		List<Resposta> list = findByPerguntaId(perguntaId, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Resposta[] findByPerguntaId_PrevAndNext(long id, long perguntaId,
		OrderByComparator orderByComparator)
		throws NoSuchRespostaException, SystemException {
		...
		try {
			...
			array[0] = getByPerguntaId_PrevAndNext(session, resposta,
					perguntaId, orderByComparator, true);

			array[1] = resposta;

			array[2] = getByPerguntaId_PrevAndNext(session, resposta,
					perguntaId, orderByComparator, false);
	...
	protected Resposta getByPerguntaId_PrevAndNext(Session session,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByPerguntaId(long perguntaId) throws SystemException {
		for (Resposta resposta : findByPerguntaId(perguntaId)) {
			remove(resposta);
		}
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByPerguntaId(long perguntaId) throws SystemException {
		Object[] finderArgs = new Object[] { perguntaId };

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_PERGUNTAID,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_PERGUNTAID,
					finderArgs, count);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.br.com.prodevelopment.pesquisaopiniao.model.Resposta")));
	...
	private static final String _FINDER_COLUMN_PERGUNTAID_PERGUNTAID_2 = "resposta.perguntaId = ?";
