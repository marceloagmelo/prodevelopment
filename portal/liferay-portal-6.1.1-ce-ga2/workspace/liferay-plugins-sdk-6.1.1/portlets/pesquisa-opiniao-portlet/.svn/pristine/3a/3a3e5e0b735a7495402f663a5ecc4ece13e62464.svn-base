...
import br.com.prodevelopment.pesquisaopiniao.NoSuchPerguntaException;
...
import br.com.prodevelopment.pesquisaopiniao.model.impl.PerguntaModelImpl;
...
public class PerguntaPersistenceImpl extends BasePersistenceImpl<Pergunta>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_PESQUISAID =
		new FinderPath(PerguntaModelImpl.ENTITY_CACHE_ENABLED,
			PerguntaModelImpl.FINDER_CACHE_ENABLED, PerguntaImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByPesquisaId",
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PESQUISAID =
		new FinderPath(PerguntaModelImpl.ENTITY_CACHE_ENABLED,
			...
			PerguntaModelImpl.PESQUISAID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_PESQUISAID = new FinderPath(PerguntaModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !PerguntaModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((perguntaModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(perguntaModelImpl.getOriginalPesquisaId())
					};
				...
				args = new Object[] {
						Long.valueOf(perguntaModelImpl.getPesquisaId())
					};
	...
	protected Pergunta toUnwrappedModel(Pergunta pergunta) {
		...
		perguntaImpl.setPesquisaId(pergunta.getPesquisaId());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Pergunta> findByPesquisaId(long pesquisaId)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Pergunta> findByPesquisaId(long pesquisaId, int start, int end)
		throws SystemException {
	...
	public List<Pergunta> findByPesquisaId(long pesquisaId, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (Pergunta pergunta : list) {
				if ((pesquisaId != pergunta.getPesquisaId())) {
					list = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Pergunta findByPesquisaId_First(long pesquisaId,
		OrderByComparator orderByComparator)
		throws NoSuchPerguntaException, SystemException {
		Pergunta pergunta = fetchByPesquisaId_First(pesquisaId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Pergunta fetchByPesquisaId_First(long pesquisaId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Pergunta> list = findByPesquisaId(pesquisaId, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Pergunta findByPesquisaId_Last(long pesquisaId,
		OrderByComparator orderByComparator)
		throws NoSuchPerguntaException, SystemException {
		Pergunta pergunta = fetchByPesquisaId_Last(pesquisaId, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Pergunta fetchByPesquisaId_Last(long pesquisaId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByPesquisaId(pesquisaId);

		List<Pergunta> list = findByPesquisaId(pesquisaId, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Pergunta[] findByPesquisaId_PrevAndNext(long id, long pesquisaId,
		OrderByComparator orderByComparator)
		throws NoSuchPerguntaException, SystemException {
		...
		try {
			...
			array[0] = getByPesquisaId_PrevAndNext(session, pergunta,
					pesquisaId, orderByComparator, true);

			array[1] = pergunta;

			array[2] = getByPesquisaId_PrevAndNext(session, pergunta,
	...
	protected Pergunta getByPesquisaId_PrevAndNext(Session session,
		Pergunta pergunta, long pesquisaId,
	...
	public void removeByPesquisaId(long pesquisaId) throws SystemException {
		for (Pergunta pergunta : findByPesquisaId(pesquisaId)) {
			remove(pergunta);
		}
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.br.com.prodevelopment.pesquisaopiniao.model.Pergunta")));
	...
	private static final String _FINDER_COLUMN_PESQUISAID_PESQUISAID_2 = "pergunta.pesquisaId = ?";
