...
public class RespostaLocalServiceClp implements RespostaLocalService {
	...
	public br.com.prodevelopment.pesquisaopiniao.model.Resposta addResposta(
		...
		return (br.com.prodevelopment.pesquisaopiniao.model.Resposta)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<br.com.prodevelopment.pesquisaopiniao.model.Resposta> getRespostas(
		...
		return (java.util.List<br.com.prodevelopment.pesquisaopiniao.model.Resposta>)ClpSerializer.translateOutput(returnObj);
	}
