...
import br.com.prodevelopment.pesquisaopiniao.model.PesquisaModel;
...
/**
 * The base model implementation for the Pesquisa service. Represents a row in the &quot;PO_Pesquisa&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link br.com.prodevelopment.pesquisaopiniao.model.PesquisaModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link PesquisaImpl}.
 * </p>
 *
 * @author Marcelo Melo
 * @see PesquisaImpl
 * @see br.com.prodevelopment.pesquisaopiniao.model.Pesquisa
 * @see br.com.prodevelopment.pesquisaopiniao.model.PesquisaModel
 * @generated
 */
public class PesquisaModelImpl extends BaseModelImpl<Pesquisa>
	implements PesquisaModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a pesquisa model instance should use the {@link br.com.prodevelopment.pesquisaopiniao.model.Pesquisa} interface instead.
	 */
	public static final String TABLE_NAME = "PO_Pesquisa";
	...
	public static final String TABLE_SQL_CREATE = "create table PO_Pesquisa (uuid_ VARCHAR(75) null,id_ LONG not null primary key,titulo STRING null,descricao STRING null,dataInclusao DATE null,dataAlteracao DATE null,ativa BOOLEAN,companyId LONG,groupId LONG,userIdInclusao LONG,userIdAlteracao LONG)";
	public static final String TABLE_SQL_DROP = "drop table PO_Pesquisa";
	public static final String ORDER_BY_JPQL = " ORDER BY pesquisa.id ASC";
	public static final String ORDER_BY_SQL = " ORDER BY PO_Pesquisa.id_ ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.br.com.prodevelopment.pesquisaopiniao.model.Pesquisa"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.br.com.prodevelopment.pesquisaopiniao.model.Pesquisa"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.br.com.prodevelopment.pesquisaopiniao.model.Pesquisa"),
			true);
	public static long COMPANYID_COLUMN_BITMASK = 1L;
	public static long GROUPID_COLUMN_BITMASK = 2L;
	public static long UUID_COLUMN_BITMASK = 4L;
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.br.com.prodevelopment.pesquisaopiniao.model.Pesquisa"));

	public PesquisaModelImpl() {
	}
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(getCompanyId(),
			Pesquisa.class.getName(), getPrimaryKey());
	}
	...
	public Pesquisa toEscapedModel() {
		if (_escapedModelProxy == null) {
			_escapedModelProxy = (Pesquisa)ProxyUtil.newProxyInstance(_classLoader,
	...
	public Object clone() {
		...
		pesquisaImpl.setUuid(getUuid());
		pesquisaImpl.setId(getId());
		pesquisaImpl.setTitulo(getTitulo());
		pesquisaImpl.setDescricao(getDescricao());
		pesquisaImpl.setDataInclusao(getDataInclusao());
		pesquisaImpl.setDataAlteracao(getDataAlteracao());
		pesquisaImpl.setAtiva(getAtiva());
		pesquisaImpl.setCompanyId(getCompanyId());
		pesquisaImpl.setGroupId(getGroupId());
		pesquisaImpl.setUserIdInclusao(getUserIdInclusao());
		pesquisaImpl.setUserIdAlteracao(getUserIdAlteracao());
	...
	public void resetOriginalValues() {
		PesquisaModelImpl pesquisaModelImpl = this;

		pesquisaModelImpl._originalUuid = pesquisaModelImpl._uuid;

		pesquisaModelImpl._originalCompanyId = pesquisaModelImpl._companyId;

		pesquisaModelImpl._setOriginalCompanyId = false;

		pesquisaModelImpl._originalGroupId = pesquisaModelImpl._groupId;

		pesquisaModelImpl._setOriginalGroupId = false;

		pesquisaModelImpl._columnBitmask = 0;
	}

	@Override
	public CacheModel<Pesquisa> toCacheModel() {
		PesquisaCacheModel pesquisaCacheModel = new PesquisaCacheModel();

		pesquisaCacheModel.uuid = getUuid();

		String uuid = pesquisaCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			pesquisaCacheModel.uuid = null;
		}

		pesquisaCacheModel.id = getId();

		pesquisaCacheModel.titulo = getTitulo();

		String titulo = pesquisaCacheModel.titulo;

		if ((titulo != null) && (titulo.length() == 0)) {
			pesquisaCacheModel.titulo = null;
		}

		pesquisaCacheModel.descricao = getDescricao();

		String descricao = pesquisaCacheModel.descricao;

		if ((descricao != null) && (descricao.length() == 0)) {
			pesquisaCacheModel.descricao = null;
		}

		Date dataInclusao = getDataInclusao();

		if (dataInclusao != null) {
			pesquisaCacheModel.dataInclusao = dataInclusao.getTime();
		}
		else {
			pesquisaCacheModel.dataInclusao = Long.MIN_VALUE;
		}

		Date dataAlteracao = getDataAlteracao();

		if (dataAlteracao != null) {
			pesquisaCacheModel.dataAlteracao = dataAlteracao.getTime();
		}
		else {
			pesquisaCacheModel.dataAlteracao = Long.MIN_VALUE;
		}

		pesquisaCacheModel.ativa = getAtiva();

		pesquisaCacheModel.companyId = getCompanyId();

		pesquisaCacheModel.groupId = getGroupId();

		pesquisaCacheModel.userIdInclusao = getUserIdInclusao();

		pesquisaCacheModel.userIdAlteracao = getUserIdAlteracao();

		return pesquisaCacheModel;
	}
	...
	private static ClassLoader _classLoader = Pesquisa.class.getClassLoader();
	...
	private Pesquisa _escapedModelProxy;
}