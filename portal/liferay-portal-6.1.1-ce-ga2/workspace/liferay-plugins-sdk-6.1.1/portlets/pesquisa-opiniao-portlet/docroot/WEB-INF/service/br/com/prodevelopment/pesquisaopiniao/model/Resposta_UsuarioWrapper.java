...
public class Resposta_UsuarioWrapper implements Resposta_Usuario,
	...
	*/
	...
	/**
	* Returns the pesquisa usuario ID of this resposta_ usuario.
	*
	* @return the pesquisa usuario ID of this resposta_ usuario
	*/
	public long getPesquisaUsuarioId() {
		return _resposta_Usuario.getPesquisaUsuarioId();
	}

	/**
	* Sets the pesquisa usuario ID of this resposta_ usuario.
	*
	* @param pesquisaUsuarioId the pesquisa usuario ID of this resposta_ usuario
	*/
	public void setPesquisaUsuarioId(long pesquisaUsuarioId) {
		_resposta_Usuario.setPesquisaUsuarioId(pesquisaUsuarioId);
	}
	...
	*/
	...
	public com.liferay.portal.model.CacheModel<br.com.prodevelopment.pesquisaopiniao.model.Resposta_Usuario> toCacheModel() {
		return _resposta_Usuario.toCacheModel();
	}

	public br.com.prodevelopment.pesquisaopiniao.model.Resposta_Usuario toEscapedModel() {
