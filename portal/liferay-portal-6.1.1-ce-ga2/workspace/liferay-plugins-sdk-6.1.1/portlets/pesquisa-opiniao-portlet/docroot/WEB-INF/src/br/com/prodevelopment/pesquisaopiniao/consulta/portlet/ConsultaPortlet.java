package br.com.prodevelopment.pesquisaopiniao.consulta.portlet;
...
import br.com.prodevelopment.pesquisaopiniao.consulta.action.ConsultaAction;
...
public class ConsultaPortlet extends MVCPortlet {
		...
		try {
			...
			if ( (Constantes.S.equals(somenteUsuarioLogado)) && (!themeDisplay.isSignedIn()) ) {
				...
				if (Constantes.S.equals(prefConfigurado)) {
					...
					List<Pesquisa> listaPesquisa = ConsultaAction.buscar(req, res);
	...
	public void gerar(ActionRequest req, ActionResponse res) throws Exception {
		...
		ConsultaAction.gerar(req, res, idPesquisa);
	}
