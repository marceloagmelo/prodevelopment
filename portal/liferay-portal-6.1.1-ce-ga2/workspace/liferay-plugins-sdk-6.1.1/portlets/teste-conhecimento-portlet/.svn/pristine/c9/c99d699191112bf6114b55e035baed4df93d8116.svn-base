...
/**
 * The base model interface for the Teste_Usuario service. Represents a row in the &quot;TC_Teste_Usuario&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link br.com.prodevelopment.testeconhecimento.model.impl.Teste_UsuarioModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link br.com.prodevelopment.testeconhecimento.model.impl.Teste_UsuarioImpl}.
 * </p>
 *
 * @author Marcelo Melo
 * @see Teste_Usuario
 ...
 * @generated
 */
public interface Teste_UsuarioModel extends BaseModel<Teste_Usuario> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a teste_ usuario model instance should use the {@link Teste_Usuario} interface instead.
	 */
