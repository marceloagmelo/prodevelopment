 ...
 * @author Marcelo Melo
 */
public class Resposta_UsuarioLocalServiceClp
	implements Resposta_UsuarioLocalService {
	public Resposta_UsuarioLocalServiceClp(
	...
	public br.com.prodevelopment.testeconhecimento.model.Resposta_Usuario addResposta_Usuario(
		...
		return (br.com.prodevelopment.testeconhecimento.model.Resposta_Usuario)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<br.com.prodevelopment.testeconhecimento.model.Resposta_Usuario> getResposta_Usuarios(
		...
		return (java.util.List<br.com.prodevelopment.testeconhecimento.model.Resposta_Usuario>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public br.com.prodevelopment.testeconhecimento.model.Resposta_Usuario updateResposta_Usuario(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] {
						ClpSerializer.translateInput(resposta_Usuario),
