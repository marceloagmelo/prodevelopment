...
public class PerguntaLocalServiceClp implements PerguntaLocalService {
	...
	public br.com.prodevelopment.testeconhecimento.model.Pergunta addPergunta(
		...
		return (br.com.prodevelopment.testeconhecimento.model.Pergunta)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<br.com.prodevelopment.testeconhecimento.model.Pergunta> getPerguntas(
		...
		return (java.util.List<br.com.prodevelopment.testeconhecimento.model.Pergunta>)ClpSerializer.translateOutput(returnObj);
	}
