...
import br.com.prodevelopment.testeconhecimento.service.base.PerguntaLocalServiceBaseImpl;
 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link br.com.prodevelopment.testeconhecimento.service.PerguntaLocalService} interface.
 *
 * <p>
...
public class PerguntaLocalServiceImpl extends PerguntaLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this interface directly. Always use {@link br.com.prodevelopment.testeconhecimento.service.PerguntaLocalServiceUtil} to access the pergunta local service.
	 */
	@Override
	public Pergunta addPergunta(Pergunta pergunta) throws SystemException {
		...
		novaPergunta.setTesteId(pergunta.getTesteId());
		novaPergunta.setUserIdInclusao(pergunta.getUserIdInclusao());
		novaPergunta.setPontuacao(pergunta.getPontuacao());
		novaPergunta.setJustificativaResposta(pergunta.getJustificativaResposta());
		novaPergunta.setJustificativaRespostaMap(pergunta.getJustificativaRespostaMap());
