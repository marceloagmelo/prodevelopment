...
public class PerguntaWrapper implements Pergunta, ModelWrapper<Pergunta> {
	...
	*/
	...
	/**
	* Returns the justificativa resposta of this pergunta.
	*
	* @return the justificativa resposta of this pergunta
	*/
	public java.lang.String getJustificativaResposta() {
		return _pergunta.getJustificativaResposta();
	}

	/**
	* Returns the localized justificativa resposta of this pergunta in the language. Uses the default language if no localization exists for the requested language.
	*
	* @param locale the locale of the language
	* @return the localized justificativa resposta of this pergunta
	*/
	public java.lang.String getJustificativaResposta(java.util.Locale locale) {
		return _pergunta.getJustificativaResposta(locale);
	}

	/**
	* Returns the localized justificativa resposta of this pergunta in the language, optionally using the default language if no localization exists for the requested language.
	*
	* @param locale the local of the language
	* @param useDefault whether to use the default language if no localization exists for the requested language
	* @return the localized justificativa resposta of this pergunta. If <code>useDefault</code> is <code>false</code> and no localization exists for the requested language, an empty string will be returned.
	*/
	public java.lang.String getJustificativaResposta(java.util.Locale locale,
		boolean useDefault) {
		return _pergunta.getJustificativaResposta(locale, useDefault);
	}
	...
	*/
	public java.lang.String getJustificativaResposta(
		...
		return _pergunta.getJustificativaResposta(languageId);
	}
	...
	*/
	public java.lang.String getJustificativaResposta(
		...
		return _pergunta.getJustificativaResposta(languageId, useDefault);
	}

	public java.lang.String getJustificativaRespostaCurrentLanguageId() {
		return _pergunta.getJustificativaRespostaCurrentLanguageId();
	}

	public java.lang.String getJustificativaRespostaCurrentValue() {
		return _pergunta.getJustificativaRespostaCurrentValue();
	}

	/**
	* Returns a map of the locales and localized justificativa respostas of this pergunta.
	*
	* @return the locales and localized justificativa respostas of this pergunta
	*/
	public java.util.Map<java.util.Locale, java.lang.String> getJustificativaRespostaMap() {
		return _pergunta.getJustificativaRespostaMap();
	}

	/**
	* Sets the justificativa resposta of this pergunta.
	*
	* @param justificativaResposta the justificativa resposta of this pergunta
	*/
	public void setJustificativaResposta(java.lang.String justificativaResposta) {
		_pergunta.setJustificativaResposta(justificativaResposta);
	}

	/**
	* Sets the localized justificativa resposta of this pergunta in the language.
	*
	* @param justificativaResposta the localized justificativa resposta of this pergunta
	* @param locale the locale of the language
	*/
	public void setJustificativaResposta(
		java.lang.String justificativaResposta, java.util.Locale locale) {
		_pergunta.setJustificativaResposta(justificativaResposta, locale);
	}

	/**
	* Sets the localized justificativa resposta of this pergunta in the language, and sets the default locale.
	*
	* @param justificativaResposta the localized justificativa resposta of this pergunta
	* @param locale the locale of the language
	* @param defaultLocale the default locale
	*/
	...
	public void setJustificativaRespostaCurrentLanguageId(
		java.lang.String languageId) {
		_pergunta.setJustificativaRespostaCurrentLanguageId(languageId);
	}

	/**
	* Sets the localized justificativa respostas of this pergunta from the map of locales and localized justificativa respostas.
	*
	* @param justificativaRespostaMap the locales and localized justificativa respostas of this pergunta
	*/
	public void setJustificativaRespostaMap(
		java.util.Map<java.util.Locale, java.lang.String> justificativaRespostaMap) {
		_pergunta.setJustificativaRespostaMap(justificativaRespostaMap);
	}

	/**
	* Sets the localized justificativa respostas of this pergunta from the map of locales and localized justificativa respostas, and sets the default locale.
	*
	* @param justificativaRespostaMap the locales and localized justificativa respostas of this pergunta
	* @param defaultLocale the default locale
	*/
	...
	/**
	* Returns the pontuacao of this pergunta.
	*
	* @return the pontuacao of this pergunta
	*/
	public double getPontuacao() {
		return _pergunta.getPontuacao();
	}

	/**
	* Sets the pontuacao of this pergunta.
	*
	* @param pontuacao the pontuacao of this pergunta
	*/
	public void setPontuacao(double pontuacao) {
		_pergunta.setPontuacao(pontuacao);
	}
	...
	*/
	...
	/**
	* Returns the teste ID of this pergunta.
	*
	* @return the teste ID of this pergunta
	*/
	public long getTesteId() {
		return _pergunta.getTesteId();
	}

	/**
	* Sets the teste ID of this pergunta.
	*
	* @param testeId the teste ID of this pergunta
	*/
	public void setTesteId(long testeId) {
		_pergunta.setTesteId(testeId);
	}
	...
	*/
	...
	public com.liferay.portal.model.CacheModel<br.com.prodevelopment.testeconhecimento.model.Pergunta> toCacheModel() {
		return _pergunta.toCacheModel();
	}

	public br.com.prodevelopment.testeconhecimento.model.Pergunta toEscapedModel() {
