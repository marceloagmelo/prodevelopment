 ...
 * @generated
 */
public class TesteSoap implements Serializable {
	public static TesteSoap toSoapModel(Teste model) {
		TesteSoap soapModel = new TesteSoap();
	...
	public static TesteSoap[] toSoapModels(Teste[] models) {
		TesteSoap[] soapModels = new TesteSoap[models.length];
	...
	public static TesteSoap[][] toSoapModels(Teste[][] models) {
		TesteSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new TesteSoap[models.length][models[0].length];
		}
		else {
			soapModels = new TesteSoap[0][0];
		}
	...
	public static TesteSoap[] toSoapModels(List<Teste> models) {
		List<TesteSoap> soapModels = new ArrayList<TesteSoap>(models.size());

		for (Teste model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new TesteSoap[soapModels.size()]);
	}
