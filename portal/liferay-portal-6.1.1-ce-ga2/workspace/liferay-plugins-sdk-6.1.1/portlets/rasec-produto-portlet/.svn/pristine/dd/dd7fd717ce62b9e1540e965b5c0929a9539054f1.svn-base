package br.com.rasecmadeiras.produto.lista;
...
public class Constantes {
	...
	public static final String PREF_URL_DESTINO = "prefUrlDestino";
	...
	public static final String NOME_PARAM_LOCAL_CHAMADA = "localChamada";
	...
	public static final String PRODUTO_VO = "produtoVO";
	public static final String LISTA_PRODUTOS = "listaProdutos";
}