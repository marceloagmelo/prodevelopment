...
public class JournalIndexer extends BaseIndexer {
	...
	protected Document doGetDocument(Object obj) throws Exception {
		...
		String approved = String.valueOf(article.isApproved());
		String expired = String.valueOf(article.isExpired());
		...
		document.addText(Field.APPROVED, String.valueOf(approved));
		document.addText(Field.EXPIRED, String.valueOf(expired));
