...
<%@ page import="br.com.prodevelopment.portlet.conteudoweb.thumbnail.Constantes"%>
...
<%
	...
	String prefQtdeRegistros = preferences.getValue(Constantes.PREF_QTDE_REGISTROS,
			StringPool.BLANK);
	String prefQtdeRegistrosLinha = preferences.getValue(Constantes.PREF_QTDE_REGISTROS_LINHA,
			StringPool.BLANK);
	...
	String prefOrdenacao = preferences.getValue(Constantes.PREF_ORDENACAO,
			StringPool.BLANK);
	boolean prefExibirPesquisa = GetterUtil.getBoolean(preferences
			.getValue(Constantes.PREF_EXIBIR_PESQUISA, null));
	...
	boolean acoes = (prefVoltar || prefImprimir);
