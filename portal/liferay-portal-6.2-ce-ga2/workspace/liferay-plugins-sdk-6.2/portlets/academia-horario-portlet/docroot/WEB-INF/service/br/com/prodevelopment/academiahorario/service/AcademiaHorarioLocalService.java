...
/**
 * Provides the local service interface for AcademiaHorario. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcelo
 * @see AcademiaHorarioLocalServiceUtil
...
public interface AcademiaHorarioLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AcademiaHorarioLocalServiceUtil} to access the academia horario local service. Add custom service methods to {@link br.com.prodevelopment.academiahorario.service.impl.AcademiaHorarioLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
